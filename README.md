...
- [Videos](#videos)
- [Podcasts](#podcasts)
- [Customer Development](#customer-development-resources)
...
- [Founder Resources](https://www.founderresources.io/)
- [Startup Handbook](https://versionone.vc/startup-handbook/)
- [Reforge](https://www.reforge.com/) — Advanced programs on growth, retention, and product for founders and PMs
...
- [The Mom Test by Rob Fitzpatrick](https://www.amazon.com.br/Mom-Test-customers-business-everyone-ebook/dp/B01H4G2J1U) — How to talk to customers and find out if your business is a good idea
...
- [Cold Start Problem by Andrew Chen](https://www.amazon.com/Cold-Start-Problem-Andrew-Chen-ebook/dp/B08HZ5XY7X/)
- [Product-Led Growth by Wes Bush](https://productled.com/book) — How to build a product that sells itself

# Newsletters

- [TLDR](https://tldr.tech/) — Daily 5-min digest of tech, science and coding, 8M+ readers
- [Lenny's Newsletter](https://www.lennysnewsletter.com/) — Product and growth deep-dives, 1M+ subscribers
- [Founder Weekly](https://www.founderweekly.com/) — Weekly curated resources for founders
- [Stratechery](https://stratechery.com/) — Deep strategic analysis of tech and media (paid, ~$120/year)
- [Strictly VC](https://strictlyvc.com/) — Daily fundraising and deal flow news, 60k+ subscribers
- [Mostly Metrics](https://www.mostlymetrics.com/) — SaaS metrics explained: ARR, churn, CAC, LTV, payback
- [Revenue Memo](https://www.revenuememo.com/) — Pricing strategy, CAC, LTV, and GTM systems
- [The Pragmatic Engineer](https://newsletter.pragmaticengineer.com/) — Engineering and tech leadership for technical founders
...
- [Cirrus Insight — Famous pitch decks](https://www.cirrusinsight.com/blog/startup-pitch-decks)
- [Chagency — Startup funding pitch decks](https://www.chagency.co.uk/getstartupfunding/)
- [OpenDeck](https://www.openvc.app/opendeck.php)
- [Slidebean](https://slidebean.com/) — Deck builder with startup templates and VC-readiness analysis
- [Pitch](https://pitch.com/) — Modern presentation tool built for startups
- [Beautiful.ai](https://www.beautiful.ai/) — Slides that auto-format as you design
...
- [Where does growth come from? — Talks at Google](https://www.youtube.com/watch?v=rHdS_4GsKmg&ab_channel=TalksatGoogle)
...
- [Product Led Podcast](https://productled.com/podcast)
- Produto pelo Mundo
- Mulheres de Produto
...
- [The Mom Test](https://www.amazon.com.br/Mom-Test-customers-business-everyone-ebook/dp/B01H4G2J1U)
...
- [Product-Led Growth Collective](https://productled.com/) — Community and resources on PLG strategy
- [OpenView Partners Blog](https://openviewpartners.com/blog/) — Reference on PLG for B2B SaaS
- [Product-Led Growth by Wes Bush](https://productled.com/book) — The foundational book on PLG
...
- [Growthhacklist](https://growthhacklist.com/) — Global community of makers & creators building an online business
...
- [Curated List of OKR resources](https://github.com/domenicosolazzo/awesome-okr)
...
- [Techstars](https://www.techstars.com/) — Global accelerator network in 150+ cities
- [Sequoia Arc](https://www.sequoiacap.com/arc/) — Early-stage founder program by Sequoia
- [a16z START](https://a16z.com/start/) — Early-stage program by Andreessen Horowitz
- [Endeavor](https://endeavor.org/) — Scale-up support network, strong in Brazil and emerging markets
- [Distrito](https://distrito.me/) — Brazilian innovation hub and accelerator
...
- [The Hive Index — Entrepreneurship Communities](https://thehiveindex.com/topics/entrepreneurship/)
...
- [Product Hunt](http://www.producthunt.com/)
- [BetaList](https://betalist.com) — Discover and get early access to tomorrow's startup
...
- [Carta](https://carta.com/) — Market-leading cap table and equity management platform, trusted by 50k+ companies
- [Pulley](https://pulley.com/) — Founder-favorite Carta alternative with predictable pricing
- [Cake Equity](https://www.cakeequity.com/) — #1 rated equity management platform on G2
- [Qapita](https://www.qapita.com/) — Global equity management with multi-country compliance support
- [Ledgy](https://www.ledgy.com/) — Equity management for European startups
...
- [Secureframe](https://secureframe.com/) — SOC 2 and HIPAA compliance automation for startups

# Tools

## AI

- [ChatGPT](https://chatgpt.com/) — OpenAI's general-purpose AI assistant for brainstorming, writing and research
...
- [Webflow](https://webflow.com/) — Professional marketing sites and landing pages with visual design
- [Lovable](https://lovable.dev/) — Full web applications generated via AI chat
- [Bolt.new](https://bolt.new/) — AI-powered app builder for rapid MVP creation
- [Glide](https://www.glideapps.com/) — Mobile apps built from Google Sheets
- [Softr](https://www.softr.io/) — Portals and internal tools built on top of Airtable
- [Airtable](https://airtable.com/) — Visual database with automation, widely used for ops and lightweight CRMs
- [Retool](https://retool.com/) — Internal tools builder for developers
- [Unicorn Platform](https://unicornplatform.com/) — Landing pages for startups
- [An MVP is not a cheaper product — Steve Blank](http://steveblank.com/2013/07/22/an-mvp-is-not-a-cheaper-product-its-about-smart-learning/)
...
- [Beehiiv](https://www.beehiiv.com/) — Modern newsletter platform with monetization built-in
- [ConvertKit (Kit)](https://kit.com/) — Email marketing for creators and indie founders
- [Mailerlite](https://www.mailerlite.com/) — Simple, affordable email marketing with generous free plan
- [Resend](https://resend.com/) — Transactional email for developers
- [SendGrid](https://sendgrid.com/) — Transactional email at scale

## Analytics

- [Amplitude](https://amplitude.com/) — Product analytics for web and mobile
- [Hotjar](https://www.hotjar.com/) — Heatmaps, session recordings, conversion funnels and feedback surveys
- [Google Analytics](https://analytics.google.com/analytics/web/)
- [Microsoft Clarity](https://clarity.microsoft.com/) — Free heatmaps & session recordings
- [Mixpanel](https://mixpanel.com/) — Event-based product analytics with powerful funnel and retention reports
- [PostHog](https://posthog.com/) — Open-source product analytics, session recordings and feature flags

## CRM & Sales

- [HubSpot CRM](https://www.hubspot.com/products/crm) — Most widely used free CRM, great for early-stage startups
- [Pipedrive](https://www.pipedrive.com/) — Sales-focused CRM designed to help close deals faster
- [Close](https://www.close.com/) — CRM built for inside sales and B2B startups
...
- [Intercom](https://www.intercom.com/) — In-app messaging, onboarding and support platform
- [Zendesk](https://www.zendesk.com/) — Full-featured customer support suite
...
- [Slack](https://slack.com/) — Real-time team communication with powerful integrations
- [Notion](https://www.notion.so/) — All-in-one workspace for docs, wikis, and databases
- [Linear](https://linear.app/) — Issue tracking and product roadmap tool loved by startups
- [Loom](https://www.loom.com/) — Async video messaging to replace meetings and explain things visually
- [Coda](https://coda.io/) — Interactive documents that replace spreadsheets and wikis

## Automation

- [Zapier](https://zapier.com/) — Connect apps and automate workflows without code
- [Make](https://www.make.com/) — More powerful visual automation, great for complex flows
...
- [Control](https://control.rocks/) — Free customizable illustrations
- [Easel.ly](https://www.easel.ly/) — Create infographics
- [Invision](https://www.invisionapp.com/)
- [Sketch](https://www.sketch.com/)
- [Pttrns](https://pttrns.com/) — Collection of app designs
...
- [Brex](https://brex.com/) — Corporate card and spend management for startups
- [QuickBooks Online](https://quickbooks.intuit.com/) — Most widely used accounting software for startups
- [Xero](https://www.xero.com/) — Cloud-based bookkeeping, popular outside the US
- [Wave](https://www.waveapps.com/) — Free accounting for pre-revenue and early-stage startups
...
- [Stripe](https://stripe.com) — Developer-friendly payment processing, industry standard for SaaS
- [PayPal](https://www.paypal.com/br/home)
- [Adyen](https://www.adyen.com) — Enterprise-grade global payments
- [PagarMe](https://pagar.me/) — Payments for the Brazilian market
...
- [Vercel](https://vercel.com/) — Fast deployments for frontend and full-stack apps
- [Render](https://render.com/) — Modern Heroku alternative with generous free tier
- [Fly.io](https://fly.io/) — Deploy apps globally close to users

## HR & People

- [Rippling](https://www.rippling.com/) — HR, payroll, and IT management in one platform
- [Gusto](https://gusto.com/) — Payroll and benefits for US-based teams
- [Deel](https://www.deel.com/) — Hire and pay global and remote teams compliantly
- [Remote](https://remote.com/) — Employer of Record for international hiring
- [Workable](https://www.workable.com/) — Applicant tracking system for recruiting

## Market Research

- [GutCheck](https://www.gutcheckit.com/)
- [Statista](https://www.statista.com/) — Business data platform
- [Google Trends](https://trends.google.com/trends/)
- [Aytm](https://aytm.com/)
- [Similar Web](https://www.similarweb.com/pt)
- [Compass](https://www.compass.co/)
- [Review2Idea](https://review2idea.com/en/free-app-review-analysis-tool?utm_source=github&utm_medium=referral&utm_campaign=awesome_startup_resources) — Analyze public App Store and Google Play competitor reviews into evidence-backed customer interview leads before building.

## Research

- [Survey Monkey](https://pt.surveymonkey.com/)
- [Typeform](https://www.typeform.com/) — Beautiful survey and form builder with high completion rates
- [Maze](https://maze.co/) — User research and usability testing platform
...
- [SEMrush](https://www.semrush.com/) — Full-suite SEO and digital marketing platform
...
- [Namechk](https://namechk.com/) — Check name availability across domains and social media
- [BrandBucket](https://www.brandbucket.com/)
- [Squadhelp](https://www.squadhelp.com/)

## Domain Names

- [Namecheap](https://www.namecheap.com/) — Affordable domain registration with free WhoisGuard
- [Porkbun](https://porkbun.com/) — Low-cost domains with clean UX
- [GoDaddy](https://www.godaddy.com/) — Largest domain registrar in the world
- [Google Domains](https://domains.google/) — Simple registration integrated with Google Workspace
- [Instant Domain Search](https://instantdomainsearch.com/) — Real-time domain availability check as you type

## Hiring

- [Founder library about hiring](https://www.founderlibrary.com/categories/hiring)
- [Job Interviews Don't Work — Farnam Street](https://fs.blog/2020/07/job-interviews/)
- [LinkedIn Jobs](https://www.linkedin.com/jobs/) — Largest professional network for B2B and tech hiring
- [AngelList Talent](https://angel.co/jobs) — Job board focused on startup roles

---

## Contributing

Contributions are welcome! Please open a pull request with your suggestion. Make sure to:
- Add a short description to each link
- Place the resource in the most relevant existing category (or propose a new one)
- Verify that the link is working and the resource is actively maintained
